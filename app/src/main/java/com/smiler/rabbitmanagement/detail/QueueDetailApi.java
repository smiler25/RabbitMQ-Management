...
public class QueueDetailApi {
    ...
    public interface QueueDetailApiCallback {
        void onResult();
    }

    public static QueueInfo getInfo(String name) {
        return getInfo(DEFAULT_VHOST, name);
    }

    public static QueueInfo getInfo(String vhost, String name) {
